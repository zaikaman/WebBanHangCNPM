...
<div class="container py-3">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group" role="group">
            <a href="?action=quanLySanPham&query=lietke" class="btn btn-secondary btn-sm">
                <i class="fas fa-arrow-left me-2"></i>Quay lại
            </a>
            <a href="?action=quanLySanPham&query=sua&idsp=<?php echo urlencode($sp['ma_sp']); ?>" class="btn btn-warning btn-sm">
