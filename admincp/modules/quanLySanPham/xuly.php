...
if(isset($_POST['so_luong_con_lai'])) {
	$soluongconlai = $_POST['so_luong_con_lai'];
}
...
if (isset($_POST['themSanPham'])) {
	$sql_them = "INSERT INTO tbl_sanpham(ten_sp,ma_sp,gia_sp,so_luong,so_luong_con_lai,hinh_anh,tom_tat,noi_dung,tinh_trang,id_dm) VALUE('" . $tenLoaisp . "','" . $masp . "','" . $giasp . "','" . $soluong . "','" . $soluong . "','" . $hinhanh . "','" . $tomtat . "','" . $noidung . "','" . $tinhtrang . "','" . $iddm . "')";
