        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <textarea class="form-control" rows="3" readonly><?php echo stripslashes($row['tom_tat']) ?></textarea>
                    </td>
                    <td>
                        <textarea class="form-control" rows="3" readonly><?php echo stripslashes($row['noi_dung']) ?></textarea>
                    </td>
