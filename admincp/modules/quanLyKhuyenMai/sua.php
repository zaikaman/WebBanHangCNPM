...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h3 class="mb-0"><i class="fas fa-edit"></i> Chỉnh Sửa Khuyến Mãi</h3>
    </div>
    ...
    <div class="form-section">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="ten_km" class="form-control" 
                               value="<?php echo htmlspecialchars($km['ten_km']); ?>" 
                               required>
                    </div>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="loai_km" class="form-select" id="loai_km" required>
                        <option value="phan_tram" <?php echo ($km['loai_km'] == 'phan_tram') ? 'selected' : ''; ?>>
                            Giảm theo phần trăm (%)
                        </option>
                        <option value="tien_mat" <?php echo ($km['loai_km'] == 'tien_mat') ? 'selected' : ''; ?>>
                            Giảm theo số tiền (VNĐ)
                        </option>
                        <option value="gia_moi" <?php echo ($km['loai_km'] == 'gia_moi') ? 'selected' : ''; ?>>
                            Giá mới cố định (VNĐ)
                        </option>
                    </select>
                </div>
            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <textarea name="mo_ta" class="form-control" rows="3" 
                              placeholder="Mô tả chi tiết về chương trình khuyến mãi..."><?php echo htmlspecialchars($km['mo_ta']); ?></textarea>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="gia_tri_km" class="form-control" 
                               value="<?php echo $km['gia_tri_km']; ?>" 
                               step="0.01" min="0" required>
                        <span class="input-group-text fw-bold" id="unit-display">
                            <?php 
                            switch($km['loai_km']) {
                                case 'phan_tram': echo '%'; break;
                                case 'tien_mat': echo 'VNĐ'; break;
                                case 'gia_moi': echo 'VNĐ'; break;
                            }
                            ?>
                        </span>
                    </div>
                    <small class="form-text text-muted" id="value-hint">
                        ...
                        <?php 
                        switch($km['loai_km']) {
                            case 'phan_tram': echo 'Nhập phần trăm giảm giá (0-100)'; break;
                            case 'tien_mat': echo 'Nhập số tiền giảm (VNĐ)'; break;
                            case 'gia_moi': echo 'Nhập giá mới sau khuyến mãi (VNĐ)'; break;
                        }
                        ?>
                    </small>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="datetime-local" name="ngay_bat_dau" class="form-control" 
                               value="<?php echo date('Y-m-d\TH:i', strtotime($km['ngay_bat_dau'])); ?>" 
                               required>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="datetime-local" name="ngay_ket_thuc" class="form-control" 
                               value="<?php echo date('Y-m-d\TH:i', strtotime($km['ngay_ket_thuc'])); ?>" 
                               required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="trang_thai" 
                               name="trang_thai" <?php echo ($km['trang_thai'] == 1) ? 'checked' : ''; ?>>
        ...
        <?php else: ?>
            <div class="alert alert-warning">
                <i class="fas fa-exclamation-triangle"></i> Không tìm thấy khuyến mãi!
            </div>
        <?php endif; ?>
    </div>
</div>
