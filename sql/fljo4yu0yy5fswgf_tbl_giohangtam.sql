...
DROP TABLE IF EXISTS `tbl_giohangtam`;
...
LOCK TABLES `tbl_giohangtam` WRITE;
/*!40000 ALTER TABLE `tbl_giohangtam` DISABLE KEYS */;
INSERT INTO `tbl_giohangtam` VALUES (14,'','136',2),(15,'','131',3);
/*!40000 ALTER TABLE `tbl_giohangtam` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-11-18 13:54:56
