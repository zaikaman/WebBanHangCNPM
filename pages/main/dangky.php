<div class="main_content">
    ...
    if (isset($_POST['dang_ky'])) {
        ...
        if (mysqli_num_rows($check_email_query) > 0) {
            ...
            $insert_temp_stmt = $mysqli->prepare("INSERT INTO tbl_dangky_temp (ten_khachhang, email, dien_thoai, mat_khau, dia_chi_chi_tiet, token, created_at) VALUES (?, ?, ?, ?, ?, ?, NOW()) ON DUPLICATE KEY UPDATE ten_khachhang=VALUES(ten_khachhang), dien_thoai=VALUES(dien_thoai), mat_khau=VALUES(mat_khau), dia_chi_chi_tiet=VALUES(dia_chi_chi_tiet), token=VALUES(token), created_at=VALUES(created_at)");
            if ($insert_temp_stmt) {
